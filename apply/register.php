...
<html lang="en">
	...
	<body class="bg-light">
		...
		<div class="container py-3">
			...
			<main>
				<div class="py-5 text-center"> <img class="d-block mx-auto mb-4" src="../assets/img/Logo.png" alt="" width="57">
						...
						<form class="needs-validation" action="confirm.php" method="post" novalidate>
							<div class="row g-3">
								<div class="form-check">
									<select class="form-select" name="period" aria-label="Choose your policy period">
								  		<option selected disabled>Choose your policy period</option>
							...
							<div class="row g-3">
								...
								<div class="col-12">
									...
									<input type="mobile" class="form-control" id="mobile" name="mobile" placeholder="XXXXXXXXXX">
								</div>
								<div class="col-12">
								...
								<div class="col-12">
									...
									<input type="text" class="form-control" id="address2" name="address2" placeholder="Apartment or suite"> </div>
								<div class="col-md-5">
