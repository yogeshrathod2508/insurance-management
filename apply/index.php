...
session_start();
$userName = ucfirst($_SESSION['firstname']) . " " . ucfirst($_SESSION['lastname']);
?>
<!doctype html>
<html lang="en">
...
<body>
	...
	<div class="container py-3">
		<header>
			<div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
				<a href="https://getbootstrap.com/" class="d-flex align-items-center text-dark text-decoration-none">
					<span class="fs-4">&nbsp;Ek Ka Double Insurance Company</span>
				</a>
			...
			<div class="pricing-header p-3 pb-md-4 mx-auto text-center">
				...
				<p class="fs-5 text-muted">Ek Ka Double is the largest partner for most Health Insurers and a Platinum partner, which means your policy and claims will be treated on a priority. We make Health insurance more affordable for you through various monthly payment options and discounts provided by our Partners.</p>
			</div>
		</header>
		<main>
					...
					<div class="card mb-4 rounded-3 shadow-sm border-secondary">
						...
						<div class="card-body">
							...
							<form method="post" action="register.php">
								...
								<input type="submit" name="submitLite" class="w-100 btn btn-lg btn-outline-secondary" value="Register today!">
							</form>
						</div>
					</div>
				</div>
					...
					<div class="card mb-4 rounded-3 shadow-sm border-primary">
						...
						<div class="card-body">
							...
							<form method="post" action="register.php">
								...
								<input type="submit" name="submitPrem" class="w-100 btn btn-lg btn-outline-primary" value="Register today!">
							</form>
						</div>
					</div>
				</div>
					...
					<div class="card mb-4 rounded-3 shadow-sm border-warning">
						...
						<div class="card-body">
							...
							<form method="post" action="register.php">
								...
								<input type="submit" name="submitLte" class="w-100 btn btn-lg btn-outline-warning" value="Register today!">
							</form>
						</div>
					</div>
				</div>
		...
		<footer class="my-5 pt-5 text-muted text-center text-small">
			<p class="mb-1">&copy; 2021 Ek Ka Double Insurance Company</p>
		</footer>
	</div>
</body>
